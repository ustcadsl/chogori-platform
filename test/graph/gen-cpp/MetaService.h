...
class MetaServiceNull : virtual public MetaServiceIf {
 public:
  ...
  void createTag(ExecResp& /* _return */, const CreateTagReq& /* req */) override {
    return;
  }
...
class MetaService_createTag_args {
 public:
  ...
  void __set_req(const CreateTagReq& val);
...
typedef struct _MetaService_addVertices_args__isset {
  _MetaService_addVertices_args__isset() : req(false) {}
  bool req :1;
} _MetaService_addVertices_args__isset;

class MetaService_addVertices_args {
 public:

  MetaService_addVertices_args(const MetaService_addVertices_args&);
  MetaService_addVertices_args& operator=(const MetaService_addVertices_args&);
  MetaService_addVertices_args() noexcept {
  }

  virtual ~MetaService_addVertices_args() noexcept;
  AddVerticesRequest req;

  _MetaService_addVertices_args__isset __isset;

  void __set_req(const AddVerticesRequest& val);

  bool operator == (const MetaService_addVertices_args & rhs) const
  {
    if (!(req == rhs.req))
      return false;
    return true;
  ...
  bool operator < (const MetaService_addVertices_args & ) const;
...
class MetaService_addVertices_pargs {
 public:


  virtual ~MetaService_addVertices_pargs() noexcept;
  const AddVerticesRequest* req;

  uint32_t write(::apache::thrift::protocol::TProtocol* oprot) const;

};

typedef struct _MetaService_addVertices_result__isset {
  _MetaService_addVertices_result__isset() : success(false) {}
  bool success :1;
} _MetaService_addVertices_result__isset;

class MetaService_addVertices_result {
 public:

  MetaService_addVertices_result(const MetaService_addVertices_result&) noexcept;
  MetaService_addVertices_result& operator=(const MetaService_addVertices_result&) noexcept;
  MetaService_addVertices_result() noexcept {
  }

  virtual ~MetaService_addVertices_result() noexcept;
  ExecResponse success;

  _MetaService_addVertices_result__isset __isset;

  void __set_success(const ExecResponse& val);

  bool operator == (const MetaService_addVertices_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const MetaService_addVertices_result & ) const;
...
typedef struct _MetaService_addVertices_presult__isset {
  _MetaService_addVertices_presult__isset() : success(false) {}
  bool success :1;
} _MetaService_addVertices_presult__isset;

class MetaService_addVertices_presult {
 public:


  virtual ~MetaService_addVertices_presult() noexcept;
  ExecResponse* success;

  _MetaService_addVertices_presult__isset __isset;
...
class MetaServiceClient : virtual public MetaServiceIf {
 ...
 public:
  ...
  int32_t recv_add();
  void createTag(ExecResp& _return, const CreateTagReq& req) override;
  void send_createTag(const CreateTagReq& req);
  void recv_createTag(ExecResp& _return);
  void addVertices(ExecResponse& _return, const AddVerticesRequest& req) override;
...
class MetaServiceMultiface : virtual public MetaServiceIf {
 ...
 public:
  ...
  void createTag(ExecResp& _return, const CreateTagReq& req) override {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->createTag(_return, req);
    }
    ifaces_[i]->createTag(_return, req);
    return;
  }
  ...
  void addVertices(ExecResponse& _return, const AddVerticesRequest& req) override {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->addVertices(_return, req);
    }
    ifaces_[i]->addVertices(_return, req);
    return;
  }
  ...
  MetaServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  void createTag(ExecResp& _return, const CreateTagReq& req) override;
  int32_t send_createTag(const CreateTagReq& req);
  void recv_createTag(ExecResp& _return, const int32_t seqid);
  void addVertices(ExecResponse& _return, const AddVerticesRequest& req) override;
