 ...
 *  @generated
 */
#ifndef SkvGraphV2_TYPES_H
#define SkvGraphV2_TYPES_H
...
typedef struct _SpaceDesc__isset {
  _SpaceDesc__isset() : space_name(true) {}
  bool space_name :1;
} _SpaceDesc__isset;
...
class SpaceDesc : public virtual ::apache::thrift::TBase {
 public:
  ...
  SpaceDesc(const SpaceDesc&) noexcept;
  SpaceDesc& operator=(const SpaceDesc&) noexcept;
  SpaceDesc() noexcept
            : space_name(1) {
  }
  ...
  void __set_space_name(const int32_t val);
...
class SpaceItem : public virtual ::apache::thrift::TBase {
 public:
  ...
  SpaceItem(const SpaceItem&) noexcept;
  SpaceItem& operator=(const SpaceItem&) noexcept;
  SpaceItem() noexcept
            : space_id(0) {
  }
...
class CreateSpaceReq : public virtual ::apache::thrift::TBase {
 public:
  ...
  CreateSpaceReq(const CreateSpaceReq&) noexcept;
  CreateSpaceReq& operator=(const CreateSpaceReq&) noexcept;
