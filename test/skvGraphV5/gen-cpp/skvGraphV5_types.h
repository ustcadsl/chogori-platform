 ...
 *  @generated
 */
#ifndef skvGraphV5_TYPES_H
#define skvGraphV5_TYPES_H
...
typedef struct _ExecResp__isset {
  _ExecResp__isset() : code(false), id(false), leader(false) {}
  bool code :1;
  bool id :1;
  bool leader :1;
} _ExecResp__isset;
...
class ExecResp : public virtual ::apache::thrift::TBase {
 public:
  ...
  ExecResp(const ExecResp&);
  ExecResp& operator=(const ExecResp&);
  ExecResp() noexcept
  ...
  void __set_leader(const HostAddr& val);
...
typedef struct _GraphSchema__isset {
  _GraphSchema__isset() : columns(false), schema_prop(false) {}
  bool columns :1;
  bool schema_prop :1;
} _GraphSchema__isset;

class GraphSchema : public virtual ::apache::thrift::TBase {
 public:

  GraphSchema(const GraphSchema&);
  GraphSchema& operator=(const GraphSchema&);
  GraphSchema() noexcept {
  }

  virtual ~GraphSchema() noexcept;
  std::vector<ColumnDef>  columns;
  SchemaProp schema_prop;

  _GraphSchema__isset __isset;

  void __set_columns(const std::vector<ColumnDef> & val);

  void __set_schema_prop(const SchemaProp& val);

  bool operator == (const GraphSchema & rhs) const
  {
  ...
  bool operator < (const GraphSchema & ) const;
...
typedef struct _CreateTagReqTest__isset {
  _CreateTagReqTest__isset() : space_name(false), tag_name(false), graph_schema(false), if_not_exists(false) {}
  bool space_name :1;
  bool tag_name :1;
  bool graph_schema :1;
  bool if_not_exists :1;
} _CreateTagReqTest__isset;

class CreateTagReqTest : public virtual ::apache::thrift::TBase {
 public:

  CreateTagReqTest(const CreateTagReqTest&);
  CreateTagReqTest& operator=(const CreateTagReqTest&);
  CreateTagReqTest() noexcept
                   : space_name(),
                     tag_name(),
                     if_not_exists(0) {
  }

  virtual ~CreateTagReqTest() noexcept;
  std::string space_name;
  std::string tag_name;
  GraphSchema graph_schema;
  bool if_not_exists;

  _CreateTagReqTest__isset __isset;

  void __set_space_name(const std::string& val);

  void __set_tag_name(const std::string& val);

  void __set_graph_schema(const GraphSchema& val);

  void __set_if_not_exists(const bool val);

  bool operator == (const CreateTagReqTest & rhs) const
  {
    if (!(space_name == rhs.space_name))
      return false;
    if (!(tag_name == rhs.tag_name))
      return false;
    if (!(graph_schema == rhs.graph_schema))
      return false;
    if (!(if_not_exists == rhs.if_not_exists))
      return false;
    return true;
  ...
  bool operator < (const CreateTagReqTest & ) const;
