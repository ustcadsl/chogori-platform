...
PmemPLog=/mnt/pmem0/chogori-engine
...
./build/src/k2/cmd/nodepool/nodepool -c3 --tcp_endpoints ${EPS} --k23si_persistence_endpoint ${PERSISTENCE} ${COMMON_ARGS} --k23si_pmem_engine_path ${PmemPLog} --prometheus_port 63001 --k23si_cpo_endpoint ${CPO} --tso_endpoint ${TSO} --memory=3G --partition_request_timeout=6s &
nodepool_child_pid=$!
