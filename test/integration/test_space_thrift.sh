...
./build/test/skvGraphV3/skv_test_v3 --cpo ${CPO} --tcp_remotes ${EPS[@]} --enable_tx_checksum true --reactor-backend epoll --prometheus_port 63100 --tso_endpoint ${TSO}
