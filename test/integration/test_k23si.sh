...
./build/src/k2/cmd/nodepool/nodepool --log_level INFO k2::skv_server=DEBUG k2::indexer=DEBUG k2::transport=DEBUG k2::hot=DEBUG -c3 --tcp_endpoints ${EPS} --enable_tx_checksum true --k23si_persistence_endpoint ${PERSISTENCE} --reactor-backend epoll --prometheus_port 63001 --k23si_cpo_endpoint ${CPO} --tso_endpoint ${TSO} &
nodepool_child_pid=$!
