...
class MetaServiceHandler : virtual public MetaServiceIf {
 public:
  MetaServiceHandler(int argc, char **argv, App* app, App* ___app) : _app(app), __app(___app) {
...
int main(int argc, char **argv) {
  ...
  ::std::shared_ptr<MetaServiceHandler> handler(new MetaServiceHandler(argc,argv,&app,&_app));
